...
# run locally with "  python3 -m flask run  "
...
app.config['MONGO_URI'] = "mongodb+srv://root:staunton1@myfirstcluster-mknew.mongodb.net/recipe_book?retryWrites=true&w=majority"
